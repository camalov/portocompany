            ...
            <h2>Redaktə<small>              
              ...
              <?php }else if($_GET['status']=='false'){ ?>
                ...
                <form action="dbnet/operations.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    ...
                    <div class="col-md-55">
                      <div class="thumbnail">
                        <div class="image view view-first">
                          <img style="width:100%; height:75%; display: block;" src="<?php echo "../../".$news_result['news_img_url']; ?>" alt="<?php echo "../../".$news_result['news_img_url']; ?>" />
                          <div class="mask">
                            <p><?php echo $news_result['news_name']; ?></p>
                            <div class="tools tools-bottom">
                            </div>
                          </div>
                        </div>
                        <div class="caption">
                          <p>Mövcud Paylaşım mövzunuz</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3" for="first-name">Paylaşım mövzusu </label>
                    <div class="col-md-6">
                      <input type="file" name="news_photo_url" value="" id="first-name2" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="news_name" placeholder="Paylaşım adını daxil edin" value="<?php echo $news_result['news_name']; ?>" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="news_author" value="<?php echo $news_result['news_author']; ?>"  id="first-name2" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="news_keywords" value="<?php echo $news_result['news_keywords']; ?>" id="first-name2" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-2">
                      <?php if($news_result['news_status']==1){ ?>
                      ...
                      <?php } else if($news_result['news_status']==0){ ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-2">
                      <textarea name="news_content" id="editor1" class="ckeditor"><?php echo $news_result['news_content']; ?></textarea>
                    </div>
                  </div>

                  <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <button type="submit" name="news_edit" class="btn btn-primary">Yadda saxla</button>
                  </div>
                </form>        
              </form>
            </div>
